...
def compete():
    ...
    if request.method == 'POST':
        if 'photo' in request.files:
            ...
            # I need to change this so that the filenames are 
            # generated by me to ensure they are always unique.
            ...
            #photo_to_store = mongo.send_file(photo.filename)
            # mongo.db.users.update("photos": # find a way of putting this photo object in this array)
